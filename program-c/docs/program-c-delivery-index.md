...
- Latest Feishu text config is now local content/reference data, but Day 7 full branches, ending report generation, and UI/system copy are not yet implemented as complete playable flows.
- D8 mini-games have real rule handling for Day 1 / 2 / 3 / 4 / 5 / 6, but still need human playtest tuning for spacing, copy density, and feel.
