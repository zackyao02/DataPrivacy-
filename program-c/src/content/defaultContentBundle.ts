...
import endingReportTemplatesData from "../../data/ending_report_templates.json";
...
export const defaultContentBundle: ContentBundle = {
  ...
  endingReportTemplates: endingReportTemplatesData as readonly EndingReportTemplate[],
